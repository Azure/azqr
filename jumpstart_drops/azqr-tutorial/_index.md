...
2. Run the following command to install Azure Quick Review:
...
2. You can install Azure Quick Review using `winget` by running:
   ...
   Alternatively, you can download and install using the install script:
...
This example demonstrates how to use Azure Quick Review to scan an Azure subscription for compliance. For further details on filtering recommendations or troubleshooting, refer to the [usage](https://azure.github.io/azqr/docs/usage/)  and [troubleshooting](https://azure.github.io/azqr/docs/troubleshooting/) sections in the documentation.
