...
func init() {
	models.ScannerFactoryList["psql"] = []models.ScannerFactory{
		func() models.IAzureScanner { return &PostgreScanner{} },
		func() models.IAzureScanner { return &PostgreFlexibleScanner{} },
	}
}
