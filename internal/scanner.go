...
import (
	...
	// Scanner registry - replaces 51 individual scanner imports
...
func (sc Scanner) initializeLogLevel(debug bool) {
	...
	if debug {
		...
		// Log scanner registry information
		sc.logScannerRegistryInfo()
	}
}

// logScannerRegistryInfo logs information about registered scanners (debug mode)
func (sc Scanner) logScannerRegistryInfo() {
