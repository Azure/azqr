...
[![Github All Releases](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/Azure/azqr/badges/downloads.json)](https://github.com/Azure/azqr/releases)
...
<details>
<summary><strong>Click to expand supported services (70+ resource types)</strong></summary>
...
> For the full list of resource type abbreviations used in filters, see the [Overview documentation](https://azure.github.io/azqr/docs/overview/).
...
Or download the latest release from the [releases page](https://github.com/Azure/azqr/releases).
