...
**Azure Quick Review (azqr)** scans your resources with 4 types of recommendations:
...
* **Azure Policy** compliance checks that identify non-compliant resources based on Azure Policy states
...
* **AzurePolicy**: a list of non-compliant resources based on Azure Policy states, showing policy violations and their details including policy display names, descriptions, definition IDs, assignment information, and timestamps.
